...
module ScratchPadKeys (
    ...
    scratchTerminal, scratchTop,scratchRanger,scratchterm,
    -- * ManageHooks
    -- $managehooks
...
scratchPadList = [scratchMixer, scratchMusic, scratchTop, scratchRanger, scratchTerminal,scratchterm]
...
-- | ranger center screen
scratchRanger :: ScratchPad
scratchRanger = ScratchPad
    { keybind = "M4-r"
...
-- | top screen terminal
scratchterm :: ScratchPad
scratchterm = ScratchPad
    { keybind = "M4-s"
    , cmd     = "urxvtc -name sp-screen -e screen -xRR"
    , query   = resource =? "sp-screen"
    , hook    = centerScreen 0.70
    }
